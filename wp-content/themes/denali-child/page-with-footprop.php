<?php
/**
 * Template Name: Page with property footer
 *
 */
?>
...
<?php get_template_part('attention', 'page'); ?>
 ...
 <div class="cboth"></div>
  <?php get_template_part('content','single-property-bottom-page'); ?>
 <?php //echo do_shortcode( '[featured_properties status="for_sale" ]' ); ?>
  </div>
