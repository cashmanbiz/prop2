    ...
    ?>
   	<div class="thebreadcrumb">
   		...
   		if ( function_exists( 'breadcrumb_trail' ) ){
   			...
   			if($post->property_type=="single_family_home"){
   				$parenthref="for-sale";
   				$parentdescription="For Sale";
   			} elseif($post->property_type=="to_rent"){
   			  	$parenthref="to-rent";
   				$parentdescription="To Rent";
   			}
   			?>
   			
  
   			<a href="<?php bloginfo('url'); ?>">Home</a> - <a href="<?php echo bloginfo('url')."/"; ?><?php echo $parenthref; ?>">
   			<?php echo $parentdescription ;?></a> 
